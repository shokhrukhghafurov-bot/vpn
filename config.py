...
class Settings:
    ...
    VPN_IMPORT_ON_STARTUP: bool = _env_bool("VPN_IMPORT_ON_STARTUP", True)
    VPN_IMPORT_AUTO_ENABLED: bool = _env_bool("VPN_IMPORT_AUTO_ENABLED", True)
    VPN_IMPORT_DEFAULT_REFRESH_MINUTES: int = _env_int("VPN_IMPORT_DEFAULT_REFRESH_MINUTES", 10)
    VPN_IMPORT_WORKER_POLL_SECONDS: int = _env_int("VPN_IMPORT_WORKER_POLL_SECONDS", 60)
    VPN_IMPORT_FETCH_TIMEOUT_SEC: int = _env_int("VPN_IMPORT_FETCH_TIMEOUT_SEC", 20)
    VPN_IMPORT_DISCOVERY_DEPTH: int = _env_int("VPN_IMPORT_DISCOVERY_DEPTH", 3)
