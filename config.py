...
class Settings:
    ...
    HIDDIFY_WINDOWS_APP_URL: str = os.getenv("HIDDIFY_WINDOWS_APP_URL", os.getenv("WINDOWS_APP_URL", "https://app.hiddify.com/windows"))
    HIDDIFY_MACOS_APP_URL: str = os.getenv("HIDDIFY_MACOS_APP_URL", os.getenv("MACOS_APP_URL", "https://app.hiddify.com/mac"))
