...
class Settings:
    ...
    SUBSCRIPTION_ALLOW_READY_FALLBACK: bool = _env_bool("SUBSCRIPTION_ALLOW_READY_FALLBACK", False)
    USER_CONFIG_ALLOW_READY_FALLBACK: bool = _env_bool("USER_CONFIG_ALLOW_READY_FALLBACK", False)
    AUTO_VIRTUAL_ALLOW_READY_FALLBACK: bool = _env_bool("AUTO_VIRTUAL_ALLOW_READY_FALLBACK", False)
    ...
    def __post_init__(self) -> None:
        ...
        if self.VLESS_ANTI_BLOCK_SNI_POOL is None:
            self.VLESS_ANTI_BLOCK_SNI_POOL = _env_list("VLESS_ANTI_BLOCK_SNI_POOL", "www.cloudflare.com,www.cloudflare-dns.com,cp.cloudflare.com,cdn.cloudflare.com")
        if self.VLESS_ANTI_BLOCK_SNI_POOL_RU_LTE is None:
            self.VLESS_ANTI_BLOCK_SNI_POOL_RU_LTE = _env_list("VLESS_ANTI_BLOCK_SNI_POOL_RU_LTE", ",".join(self.VLESS_ANTI_BLOCK_SNI_POOL or ["www.cloudflare.com","www.cloudflare-dns.com","cp.cloudflare.com","cdn.cloudflare.com"]))
        if self.VLESS_ANTI_BLOCK_SNI_POOL_INTL is None:
            self.VLESS_ANTI_BLOCK_SNI_POOL_INTL = _env_list("VLESS_ANTI_BLOCK_SNI_POOL_INTL", ",".join(self.VLESS_ANTI_BLOCK_SNI_POOL or ["www.cloudflare.com","www.cloudflare-dns.com","cp.cloudflare.com","cdn.cloudflare.com"]))
